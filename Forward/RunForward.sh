...
cp -r {Forward.sif,Forward.sif.bak,Submit.sh,Submit0.sh,Derwael.nc,Derwael_SMB.nc,Derwael_BMB.nc,ModulesPlusPathsMistralGCC71.sh,Makefile,src} Simulations/${Name}
