...
cp -r {Forward.sif,Forward.sif.bak,Submit.sh,Submit0.sh,Derwael.nc,Derwael_SMB.nc,Derwael_BMB.nc,Derwael_SurfTemp.nc,ModulesPlusPaths2LoadIntelMPI.sh,Makefile,src} Simulations/${Name}
